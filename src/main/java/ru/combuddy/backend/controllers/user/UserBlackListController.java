...
public class UserBlackListController {
    ...
    void add(@PathVariable String aggressorUsername, @PathVariable String defendedUsername) {
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    void remove(@PathVariable String aggressorUsername, @PathVariable String defendedUsername) {
    ...
    UsernamesList getAggressorsUsernames(@PathVariable String defendedUsername) {
