...
public class UserSubscriptionController {
    ...
    void subscribe(@PathVariable String subscriberUsername, @PathVariable String posterUsername) {
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    void unsubscribe(@PathVariable String subscriberUsername, @PathVariable String posterUsername) {
    ...
    UsernamesList getPosterUsernames(@PathVariable String subscriberUsername) {
    ...
    UsernamesList getSubscriberUsernames(@PathVariable String posterUsername) {
